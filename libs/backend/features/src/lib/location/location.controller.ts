import { Body, Controller, Delete, Get, Logger, Param, Put, Post, UseGuards } from '@nestjs/common';
import { LocationService } from './location.service';
import { BodyObjectIdsPipe, Id, ILocation, IUpdateLocation, Role, stringObjectIdPipe } from '@lingua/api'
