...
export class UserController {
    ...
    @Get()
    async getAll(): Promise<IUser[]> {return await this.userService.getAll()}
    ...
    @Put(':id')
    async update(@Param('id', stringObjectIdPipe) id:Id, @Body(BodyObjectIdsPipe) body: IUpdateUser): Promise<IUser> {
